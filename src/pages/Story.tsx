  ...
  return (
    <div style={{ background: '#fff' }}>
      <section style={{ padding: '5rem 2rem 7rem', position: 'relative', overflow: 'hidden' }}>
        <div style={{ position: 'absolute', top: 0, right: 0, width: 500, height: 500, borderRadius: '50%', background: 'radial-gradient(circle, rgba(94,138,140,0.08) 0%, transparent 70%)', pointerEvents: 'none' }} />
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto', position: 'relative' }}>
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', background: '#F4F1E9', border: '1px solid rgba(94,138,140,0.25)', borderRadius: 50, padding: '0.35rem 1rem 0.35rem 0.6rem', marginBottom: '2rem' }}>
            ...
            <span style={{ fontFamily: 'Nunito, sans-serif', fontSize: '0.78rem', fontWeight: 700, color: '#48696C' }}>02 — Our Story</span>
          </div>

          <h2 style={{ fontFamily: 'DM Serif Display, Georgia, serif', fontSize: 'clamp(2rem, 3.5vw, 3.2rem)', fontWeight: 400, color: '#2C3A47', lineHeight: 1.15, margin: '0 0 3.5rem', letterSpacing: '-0.01em' }}>
            Why NAA, Why Now,{' '}
            <span style={{ color: '#5E8A8C', fontStyle: 'italic' }}>Why North Carolina</span>
          </h2>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '5rem', alignItems: 'start' }} className="story-grid">
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
              {[
                ...
                <p key={i} style={{ fontFamily: 'Nunito, sans-serif', fontSize: '1rem', fontWeight: 400, color: '#55656F', lineHeight: 1.85, margin: 0 }}>{text}</p>
              ))}
            </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
              {[
                {
                  label: 'Mission', Icon: IconTarget, iconColor: '#5E8A8C',
                  bg: 'linear-gradient(135deg, #F4F1E9, #E8EDEC)',
                  border: 'rgba(94,138,140,0.25)', labelColor: '#48696C',
                ...
                {
                  label: 'Vision', Icon: IconStar, iconColor: '#4A6B7C',
                  bg: 'linear-gradient(135deg, #F5F2EB, #EAEFEE)',
                  border: 'rgba(74,107,124,0.25)', labelColor: '#41627A',
                ...
                {
                  label: 'Why Access Matters', Icon: IconHeart, iconColor: '#5E8A8C',
                  bg: 'linear-gradient(135deg, #FAF8F3, #F4F1E9)',
                  border: 'rgba(94,138,140,0.15)', labelColor: '#55656F',
                ...
                <div key={i} style={{ padding: '1.75rem 2rem', background: card.bg, border: `1.5px solid ${card.border}`, borderRadius: 20 }}>
                  ...
                  <p style={{ fontFamily: card.serif ? 'DM Serif Display, Georgia, serif' : 'Nunito, sans-serif', fontSize: card.serif ? '1.05rem' : '0.92rem', color: '#2C3A47', lineHeight: 1.7, margin: 0, fontStyle: card.serif ? 'italic' : 'normal', fontWeight: 400 }}>{card.text}</p>
                </div>
              ))}
            </div>
          </div>
